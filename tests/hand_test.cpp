...
void testHighCard() {
  std::array<PlayingCard, 5> highCardHand = {
      PlayingCard(2, 1, 0, 0, 0), PlayingCard(5, 2, 0, 0, 0),
      PlayingCard(9, 3, 0, 0, 0), PlayingCard(7, 1, 0, 0, 0),
...
void testPair() {
  std::array<PlayingCard, 5> pairHand = {
      PlayingCard(2, 1, 0, 0, 0), PlayingCard(2, 2, 0, 0, 0),
      PlayingCard(9, 3, 0, 0, 0), PlayingCard(7, 1, 0, 0, 0),
      PlayingCard(12, 2, 0, 0, 0)};
...
void testTwoPair() {
  std::array<PlayingCard, 5> twoPairHand = {
      PlayingCard(2, 1, 0, 0, 0), PlayingCard(2, 2, 0, 0, 0),
      PlayingCard(9, 3, 0, 0, 0), PlayingCard(9, 1, 0, 0, 0),
      PlayingCard(12, 2, 0, 0, 0)};
...
void testThreeOfAKind() {
  std::array<PlayingCard, 5> threeOfAKindHand = {
      PlayingCard(2, 1, 0, 0, 0), PlayingCard(2, 2, 0, 0, 0),
      PlayingCard(2, 3, 0, 0, 0), PlayingCard(7, 1, 0, 0, 0),
      PlayingCard(12, 2, 0, 0, 0)};
...
void testStraight() {
  std::array<PlayingCard, 5> straightHand = {
      PlayingCard(2, 1, 0, 0, 0), PlayingCard(3, 2, 0, 0, 0),
      PlayingCard(4, 3, 0, 0, 0), PlayingCard(5, 1, 0, 0, 0),
...
void testFlush() {
  std::array<PlayingCard, 5> flushHand = {
      PlayingCard(2, 1, 0, 0, 0), PlayingCard(5, 1, 0, 0, 0),
      PlayingCard(9, 1, 0, 0, 0), PlayingCard(7, 1, 0, 0, 0),
...
void testFourOfAKind() {
  std::array<PlayingCard, 5> fourOfAKindHand = {
      PlayingCard(2, 1, 0, 0, 0), PlayingCard(2, 2, 0, 0, 0),
      PlayingCard(2, 3, 0, 0, 0), PlayingCard(2, 1, 0, 0, 0),
      PlayingCard(7, 2, 0, 0, 0)};
...
void testStraightFlush() {
  std::array<PlayingCard, 5> straightFlushHand = {
      PlayingCard(2, 1, 0, 0, 0), PlayingCard(3, 1, 0, 0, 0),
      PlayingCard(4, 1, 0, 0, 0), PlayingCard(5, 1, 0, 0, 0),
...
void testRoyalFlush() {
  std::array<PlayingCard, 5> royalFlushHand = {
      PlayingCard(10, 1, 0, 0, 0), PlayingCard(11, 1, 0, 0, 0),
      PlayingCard(12, 1, 0, 0, 0), PlayingCard(13, 1, 0, 0, 0),
      PlayingCard(1, 1, 0, 0, 0)};
...
void testFiveOfAKind() {
  std::array<PlayingCard, 5> fiveOfAKindHand = {
      PlayingCard(2, 1, 0, 0, 0), PlayingCard(2, 2, 0, 0, 0),
      PlayingCard(2, 3, 0, 0, 0), PlayingCard(2, 4, 0, 0, 0),
...
void testFlushHouse() {
  std::array<PlayingCard, 5> flushHouseHand = {
      PlayingCard(2, 1, 0, 0, 0), PlayingCard(2, 1, 0, 0, 0),
      PlayingCard(2, 1, 0, 0, 0), PlayingCard(7, 1, 0, 0, 0),
